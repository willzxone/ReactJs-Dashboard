...
const ProductInfo = () => {
  return (
    <div className="w-1/4 relative">
      ...
      <Card
        className="flex-col absolute bottom-[0%] left-3 z-20"
        leftIcon={<img src={StarbucksIcon} />}
        heading={
          <p className="[font-family:'DM_Sans-Bold',Helvetica] font-bold text-[#2b3674] text-[24px] tracking-[-0.48px] leading-[32px] mt-6">
            Starbucks
          </p>
        }
        value={
